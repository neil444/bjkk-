...
def setup():
    data_path  = "c:/Users/ADI/Downloads/correlation-master/correlation-master/data/Ice-Cream vs Cold-Drink vs Temperature - Ice Cream Sale vs Temperature data.csv"
